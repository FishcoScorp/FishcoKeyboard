...
This is the keyboard's PCB made using Kicad, and it uses an ESP32-S3 DevkitC to manage the larger than originally expected matrix. I also added diodes for speedy clicks because I type fast
...
This is the keyboard's case modeled in Fusion. I have it made to be low profile and flat on the desk.
